...
class FourierEncoder(nn.Module):
    ...
    def forward(self, input):
        ...
        x3 = torch.real(torch.fft.ifftn(x3, dim=(-2, -1)))
        x4 = torch.real(torch.fft.ifftn(x4, dim=(-2, -1)))
...
class One2One_noaux_encoder(nn.Module):
    def __init__(self, in_channels=3, short_connection=True):
        super(One2One_noaux_encoder, self).__init__()
        ...
        self.fourier_encoder = FourierEncoder(in_channels, cenc_channels, 3)
